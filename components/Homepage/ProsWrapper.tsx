...
export default function ProsWrapper(): JSX.Element {
  return (
    <div className="grid grid-rows-3 lg:grid-rows-1 lg:grid-cols-3 gap-12 grid-flow-col mt-16 lg:mt-28 mx-5 lg:mx-10 text-center text-purple-darkest text-lg font-light leading-normal">
      <Pros
        imageAlt="pros_alt1"
