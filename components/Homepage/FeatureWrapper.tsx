...
export default function FeatureWrapper(): JSX.Element {
  return (
    <div className="mt-10 lg:mt-20">
      ...
      <div className="px-5 lg:px-10 lg:mt-10 grid grid-rows-1 lg:grid-cols-2 lg:grid-flow-row lg:auto-rows-max flex items-center py-10">
      ...
      <div className="mt-3 lg:mt-20 grid grid-rows-1 lg:grid-cols-2 lg:gap-12 flex items-center bg-gray-light py-10 lg:py-20 px-5 lg:px-10">
        <FeatureImage
      ...
      <div className="mt-10 lg:mt-20 grid grid-cols-1 flex flex-row items-center justify-center text-center w-full px-5 lg:px-10">
        <Feature
          title={'feature3'}
      ...
      <div className="my-10 lg:my-32 grid grid-rows-1 lg:grid-cols-2 grid-flow-row auto-rows-max flex items-center px-5 lg:px-10">
