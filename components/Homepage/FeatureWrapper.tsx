...
export default function FeatureWrapper(): JSX.Element {
  return (
    <div className="mt-10 lg:mt-20">
      ...
      <div className="mt-3 lg:mt-20 bg-gray-light lg:py-20">
      ...
      <div className="mt-10 lg:mt-20 grid grid-cols-1 flex flex-row items-center justify-center text-center w-full px-5 lg:px-10 container-width">
        <Feature
          title={'feature3'}
