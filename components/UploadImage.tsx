  ...
  return (
    <div className="pt-1 pb-6">
      <div className="mt-1 flex flex-col xl-custom:flex-row items-center">
        ...
        <button
          type="button"
          className="w-full xl-custom:w-36 mt-5 xl-custom:mt-0 xl-custom:ml-5 bg-white py-2 px-3 border-gray border-rounded-base text-sm text-purple focus:outline-none focus:bg-white focus:border-gray
        ...
        {isImageSet ? (
          <button
            type="button"
            className="mt-5 xl-custom:mt-0 w-full xl-custom:w-36 xl-custom:ml-5 bg-red-500 py-2 px-3 border-rounded-base text-sm text-white focus:outline-none focus:bg-red-500
