...
export default function CatDetailEmptyBox(): JSX.Element {
  ...
  return (
    <div className="flex justify-center flex-col min-h-auto items-center py-10 text-center min-h-screen">
      <Image src="/icons/no_cats.svg" height={205} width={150} />
      <h2 className="text-2xl font-medium text-purple-darkest mt-5">
        {t(cs['no_cat_added'])}
      </h2>
      <p className="font-light lg:px-32 text-center pt-3.6 pb-6 text-purple-darkest leading-normal xxl-custom:w-3/5">
